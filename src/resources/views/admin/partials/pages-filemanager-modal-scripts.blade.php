...
window.addEventListener('message', function(event) {
    ...
    function fmSetLink(fullUrl) {
        ...
        localStorage.setItem('imageForPage{{ $page->id }}', pathname);
    }
    ...
    function removeImage() {
        ...
        localStorage.removeItem('imageForPage{{ $page->id }}');
    }
...
// Function to check for an image on start.
    ...
    var savedUrl = localStorage.getItem('imageForPage{{ $page->id }}');
        if (savedUrl) {
