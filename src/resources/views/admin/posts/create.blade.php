...
@if ($errors->any())
    ...
    <div class="row">
        <div class="col-md-9">
            <h1 class="mt-4"><i class="far fa-newspaper"></i> Create Post</h1>
...
<div class="card mb-3">
    ...
    <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
        <div class="card-body">
            <input name="categories" id="tagify-categories" placeholder="Enter categories" value="">
...
<div class="card mb-3">
    ...
    <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
        <div class="card-body">
            <input name="tags" id="tagify-tags" placeholder="Enter tags" value="">
...
<div class="card mb-3">
    <div class="card-header" id="headingFour">
        <h2 class="mb-0">
            ...
            <span>
             <i class="mdi mdi-image-outline"></i> Post header image
            </span>
            </button>
        </h2>
    </div>
